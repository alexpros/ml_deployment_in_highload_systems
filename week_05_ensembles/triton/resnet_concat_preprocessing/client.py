...
output_path = "./infer_inputs_concat.npy"
URL = "localhost:19094"
VERBOSE = False
...
EXPECTED_INPUTS_NUM = 2
EXPECTED_OUTPUTS_NUM = 1
EXPECTED_INPUTS_DTYPES = [{"FP32"}, {"FP32"}]
EXPECTED_INPUTS_DIMS = [[3, 224, 224], [3, 224, 224]]
EXPECTED_OUTPUTS_DIMS = [[3, 224, 224]]  # Batch dimension not included
...
def main():
    ...
    images_1 = np.load("./infer_inputs.npy")
    images_2 = np.load("./infer_inputs_v2.npy")
    inputs_data = [
        images_1, images_2
       ] 
